...
## Should probably consider using https://sdkman.io/sdks
...
echo "####### install Cloud Foundry client"
...
echo "####### set up ssh key with no Password"
...
echo "####### Set up Google Authenticator Two factor Auth"
